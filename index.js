...
let animalsArray = farmAnimals.split(' ');
...
animalsArray2.slice(-1)

const [blackAndWhite, black, pink] = animalsArray2
...
const newColors2 = [...colors].splice(-2, 1)

const [indg] = newColors2
